...
namespace Djalma.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(DjalmaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VendedorId,Nome,Email")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorId,Nome,Email")] Vendedor vendedor)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DjalmaDbContext.Vendedores'  is null.");
            }
            var vendedor = await _context.Vendedores.FindAsync(id);
            if (vendedor != null)
            {
